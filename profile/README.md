<p align="center">
  <a href="https://pimcore.com/"><img src="../img/logo.svg" alt="Pimcore" width="350"></a>
</p>
...
![Pimcore platform overview](../img/pimcore-general.png)
...
- **Data Objects** — manage any structured data based on a class-editor-defined model, either manually or via API.
  ...
  ![Data objects management screenshot](../img/pimcore-objects.png)
...
- **Assets (DAM)** — store and manage any file type. Preview 200+ formats directly in Pimcore, auto-generate
  ...
  ![Digital asset management (DAM) screenshot](../img/pimcore-assets.png)
...
- **Documents (DXP/CMS)** — build pages with Twig templates and inline editables, with full multilingual and multi-site 
  ...
  ![Document and page management (DXP/CMS) screenshot](../img/pimcore-documents.png)
